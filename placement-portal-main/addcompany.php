...
if(isset($_POST)) {
	...
	if($result->num_rows == 0) {
		...
		//sql new registration insert query - default active='2' (Pending Admin Approval)
		$sql = "INSERT INTO company(name, companyname, country, state, city, contactno, website, email, password, aboutme, logo, active) VALUES ('$name', '$companyname', '$country', '$state', '$city', '$contactno', '$website', '$email', '$password', '$aboutme', '$file', '2')";
