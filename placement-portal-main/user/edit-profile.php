                ...
                ?>
                    <div class="row">
                      ...
                      <div class="col-md-6 latest-job ">
                        ...
                        <div class="form-group" style="background:#f8fafc;padding:16px;border-radius:12px;border:1px solid #e2e8f0;margin-top:16px;">
                          <label style="font-size:15px;color:#0f172a;"><i class="fa fa-file-pdf-o text-red"></i> Upload / Change Resume</label>
                          <input type="file" name="resume" class="btn btn-default" style="margin-bottom:10px;">
                          
                          <?php 
                          $resumePath = "../uploads/resume/" . ($row['resume'] ?? '');
                          if (!empty($row['resume']) && file_exists($resumePath)): 
                          ?>
                            <div style="margin-top:10px;display:flex;gap:8px;flex-wrap:wrap;">
                              <a href="../uploads/resume/<?php echo $row['resume']; ?>" target="_blank" class="btn btn-info btn-sm" style="border-radius:6px;font-weight:600;">
                                <i class="fa fa-eye"></i> View Current Resume
                              </a>
                              <a href="resume-review.php" class="btn btn-success btn-sm" style="border-radius:6px;font-weight:600;">
                                <i class="fa fa-bolt"></i> View AI ATS Score & Report
                              </a>
                            </div>
                            <small class="text-muted" style="display:block;margin-top:6px;">Current Resume File: <strong><?php echo htmlspecialchars($row['resume']); ?></strong></small>
                          <?php else: ?>
                            <small class="text-danger" style="display:block;margin-top:6px;">No valid resume uploaded yet. Upload a PDF resume to generate your AI ATS Report.</small>
                          <?php endif; ?>
                        </div>
