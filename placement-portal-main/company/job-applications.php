            ...
            <div class="col-md-9 bg-white padding-2">
              ...
              if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                  $aiMatch = analyzeResumeMatch($row, $row);
              ?>
                  <div class="attachment-block clearfix padding-2" style="border-radius:10px;border-left:4px solid <?php echo $aiMatch['badge_color']; ?>;">
                    <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;">
                      <h4 class="attachment-heading" style="margin:0;">
                      ...
                      <span style="background:<?php echo $aiMatch['badge_bg']; ?>;color:<?php echo $aiMatch['badge_color']; ?>;font-weight:700;font-size:12px;padding:4px 10px;border-radius:50px;">
                        🤖 AI Match: <?php echo $aiMatch['score']; ?>% (<?php echo $aiMatch['verdict']; ?>)
                      </span>
                    </div>
                    <div class="attachment-text padding-2" style="margin-top:8px;">
                      <div class="pull-left"><i class="fa fa-calendar"></i> Applied on: <?php echo date("d-M-Y", strtotime($row['createdat'])); ?></div>
                      <?php
                      if ($row['status'] == 0) {
